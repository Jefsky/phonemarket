					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1" class="td"> 
						<tr>
							<td colspan="13"><div align="right">
								<a href="bookadd.jsp">新建</a>&nbsp;&nbsp;&nbsp;&nbsp;
								<a href="booksearch.jsp">查询</a>
							</div></td>
						</tr>
						<tr>
...
%>
							<tr>
								...
								<td>
								<a href="../BDeteleBookServlet?bookid=<%=phone.getPhoneid() %>">删除</a>
								<a href="../BQueryByIdServlet?bookid=<%=phone.getPhoneid() %>">修改</a>
								</td>
